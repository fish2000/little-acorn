...
FUNCTION(COMPILE_PCH pch_source_arg)
    ...
    IF(pch_ext STREQUAL ".m" OR pch_ext STREQUAL ".mm")
        ...
        IF(pch_ext STREQUAL ".m")
            ...
            LIST(APPEND pch_flags "-emit-pch")
        ...
        # message("\${pch_name}.pch: ${pch_name}.pch")
        # message("\${pch_name}-no-arc.pch: ${pch_name}-no-arc.pch")
        # message("__________________________________________________")
        IF(pch_target_count GREATER 0)
            FOREACH(TN ${pch_target_names})
                ...
                #     "-include-pch ${pch_target_file} -Winvalid-pch")
